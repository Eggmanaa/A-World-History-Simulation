-- Through History Database Schema
-- World History Simulation Game
...
CREATE TABLE IF NOT EXISTS civilizations (
  ...
  wonder TEXT,
  religion_name TEXT,
  religion_tenants TEXT, -- JSON array
  writing TEXT,
  culture_tag TEXT,
...
CREATE TABLE IF NOT EXISTS event_log (
  ...
  affected_civ_ids TEXT, -- JSON array
  created_at INTEGER NOT NULL,
  FOREIGN KEY (simulation_id) REFERENCES simulations(id)
);

-- Civilization Presets (for initial setup)
CREATE TABLE IF NOT EXISTS civ_presets (
  ...
  starting_traits TEXT, -- JSON array
