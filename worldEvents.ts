...
export const WORLD_EVENTS: WorldEvent[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      {
        id: 'C',
        label: 'Send Aid / Raid the Weak',
        description: 'Non-river civs choose: help neighbors or exploit their weakness.',
        effects: [
          { type: 'modify_stat', stat: 'culture', value: 1, message: '+1 Culture Total from compassion or conquest.' },
